...
export default function Footer() {
  return <footer className="border-t border-line py-12">
    <div className="container flex flex-col justify-between gap-7 md:flex-row">
      <div>
        <div className="text-lg font-extrabold">Data<span className="text-lime">Forge</span><span className="text-lime">.</span></div>
      ...
      <div className="text-sm text-muted">© 2026 DataForge</div>
    </div>
  </footer>
}
